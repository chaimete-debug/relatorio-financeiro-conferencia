...
async function exportarWord() {
  ...
  if (!lib) { alert('Biblioteca Word não carregou. Verifique a ligação à internet e recarregue a página.'); return; }

  const { Document, Packer, Paragraph, TextRun, Table, TableRow, TableCell,
          AlignmentType, WidthType, BorderStyle, ShadingType, HeadingLevel } = lib;
  ...
  try {
    ...
    alert('Erro ao gerar ficheiro Word: ' + err.message);
  }
}
